...
const ContractWallet = require('.ContractWallet');
...
const KumaTokenChaincode = class extends ChaincodeBase {
    ...
    async transfer(stub, txHelper, amount, toAddress, fromAddress = undefined) {
        ...
        let fromWallet;
        if (fromAddress) {   //if from address undefined
            ...
            fromWallet = await this.retrieveOrCreateMyWallet(stub, txHelper);  //use identity to create address.
        }
